...
export const metadata: Metadata = {
  ...
  description:
    'Granola elaborada artesanalmente en pequeños lotes con ingredientes de Málaga. Miel local, frutos secos premium. 3 sabores únicos. Reserva con entrega en mano en Málaga.',
  keywords: [
    'granola artesanal',
