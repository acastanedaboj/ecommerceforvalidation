      ...
      <div className="container-custom max-w-3xl">
        ...
        <div className="prose-custom">
          ...
          <p>
            ...
            vendedor y el consumidor, en cumplimiento del Real Decreto Legislativo 1/2007, de 16 de
            noviembre, por el que se aprueba el texto refundido de la Ley General para la Defensa de
            los Consumidores y Usuarios (LGDCU) y la Ley 3/2014, de 27 de marzo.
          </p>

          <h2>1. Identificación del vendedor</h2>
          <p>
            De conformidad con el artículo 97 de la LGDCU, se proporciona la siguiente información
            del vendedor:
          </p>
          <p>
            <strong>Titular:</strong> {BUSINESS.name}
            <br />
          ...
          <h2>3. Productos</h2>
          <p>
            Todos nuestros productos son granola Poppy elaborada con ingredientes de alta calidad.
            Las características de cada producto se detallan en su ficha correspondiente.
          </p>
          <p>
            Las imágenes de los productos son orientativas. Pueden existir ligeras variaciones
            debido al carácter artesanal de la elaboración.
          </p>
          ...
          <p>
            Los precios pueden ser modificados en cualquier momento, si bien se aplicará el precio
          ...
          <p>
            De conformidad con los artículos 102 y siguientes de la LGDCU, dispones de un plazo de{' '}
            <strong>14 días naturales</strong> desde la recepción del producto para ejercer el
            derecho de desistimiento sin necesidad de justificación.
          </p>

          <h3>8.1 Cómo ejercer el derecho de desistimiento</h3>
          <p>
            Para ejercer este derecho, debes notificárnoslo mediante una declaración inequívoca (por
            ejemplo, carta enviada por correo postal o electrónico) a las siguientes señas:
          </p>
          <ul>
            <li>
            ...
            <li>
              <strong>Dirección postal:</strong> {BUSINESS.address.street},{' '}
              {BUSINESS.address.postalCode} {BUSINESS.address.city}
            </li>
          </ul>
          <p>
            Puedes utilizar el modelo de formulario de desistimiento que encontrarás al final de
            esta sección, aunque su uso no es obligatorio.
          </p>

          <h3>8.2 Efectos del desistimiento</h3>
          <p>
            En caso de desistimiento, te devolveremos todos los pagos recibidos, incluidos los
            gastos de entrega (excepto los gastos adicionales si elegiste un método de entrega
            diferente al estándar), sin ninguna demora indebida y, en cualquier caso, a más tardar
            14 días naturales desde la fecha en que se nos informe de tu decisión de desistir.
          </p>
          <p>
            Procederemos a efectuar el reembolso utilizando el mismo medio de pago que empleaste
            para la transacción inicial, salvo que expresamente hayas dispuesto lo contrario.
          </p>
          <p>
            Deberás devolver los bienes sin demora indebida y, en cualquier caso, a más tardar en el
            plazo de 14 días naturales desde la fecha en que nos comuniques tu decisión de
            desistimiento. Los gastos directos de devolución correrán a tu cargo.
          </p>
          ...
          <ul>
            <li>
              Productos precintados que no sean aptos para ser devueltos por razones de protección
              de la salud o de higiene y que hayan sido desprecintados tras la entrega.
            </li>
            <li>
              Bienes que puedan deteriorarse o caducar con rapidez (productos alimentarios
              perecederos).
            </li>
          </ul>
          <p>
            Por tanto,{' '}
            <strong>
              no se admitirán devoluciones de productos que hayan sido abiertos o cuyo precinto de
              seguridad haya sido roto
            </strong>
            , por motivos de higiene y seguridad alimentaria.
          </p>
          ...
          <p>
            Conforme a los artículos 114 y siguientes de la LGDCU, todos nuestros productos cuentan
            con una garantía legal de conformidad de 3 años desde la entrega del bien (para
            contratos celebrados desde el 1 de enero de 2022).
          </p>

          <h3>9.1 Falta de conformidad</h3>
          <p>Se entenderá que el producto no es conforme con el contrato cuando:</p>
          <ul>
          ...
          <p>
            Si recibes un producto que no cumple con lo esperado, contacta con nosotros lo antes
            posible y en todo caso dentro de los 2 meses desde que detectaste el defecto:
          </p>
          <ul>
            <li>
              <strong>Email:</strong> {BUSINESS.email} con asunto "Reclamación producto"
            </li>
            <li>
              <strong>Proporciona:</strong> Número de pedido, fotos del producto y descripción del
              problema
            </li>
          </ul>
          <p>
            Procederemos a la reparación, sustitución, rebaja del precio o resolución del contrato,
            según corresponda y conforme a tus derechos legales.
          </p>

          <h3>9.3 Productos perecederos</h3>
          <p>
            <strong>Importante:</strong> Al tratarse de productos alimentarios perecederos, te
            recomendamos revisar el producto en el momento de la recepción y notificar cualquier
          ...
          <p>
            Todos los contenidos del sitio web (textos, imágenes, logotipos, etc.) son propiedad de{' '}
            {BUSINESS.name} y están protegidos por las leyes de propiedad intelectual.
          </p>

          <h2>12. Resolución alternativa de litigios</h2>
          <p>
            De conformidad con el Reglamento (UE) 524/2013, la Comisión Europea facilita una
          ...
          <p>
            Además, los consumidores pueden recurrir a entidades de resolución alternativa de
            litigios de consumo, como las Juntas Arbitrales de Consumo.
          </p>

          <h2>13. Ley aplicable y jurisdicción</h2>
          <p>
            Estas condiciones generales se rigen por la legislación española vigente, en particular:
          </p>
          <ul>
          ...
          <p>
            Para la resolución de cualquier controversia derivada del presente contrato, las partes
            se someten, con renuncia expresa a cualquier otro fuero que pudiera corresponderles, a
            los Juzgados y Tribunales del domicilio del consumidor, de conformidad con lo
            establecido en la normativa de protección de consumidores y usuarios.
          </p>

          <h2>14. Idioma</h2>
          <p>El idioma en que se formalizará el contrato es el español.</p>

          <h2>15. Contacto</h2>
          <p>
            Para cualquier consulta relacionada con estas condiciones o con tu pedido, puedes
          ...
          <p>
            Nuestro horario de atención al cliente es de lunes a viernes, de 9:00h a 18:00h. Nos
            comprometemos a responder a tus consultas en un plazo máximo de 48 horas laborables.
          </p>
        </div>
      </div>
    </div>
