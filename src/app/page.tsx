  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-warm overflow-hidden">
        <div className="container-custom py-24 md:py-32 lg:py-40">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div className="text-center lg:text-left max-w-xl mx-auto lg:mx-0">
              <span className="inline-block badge-accent mb-8 animate-fade-in">
            ...
            <div className="relative animate-fade-in animation-delay-200">
              <div className="relative aspect-[4/5] max-w-lg mx-auto">
                ...
                <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl shadow-card-hover p-5 animate-pulse-soft">
                ...
                {/* Decorative elements */}
                <div className="absolute -top-10 -right-10 w-32 h-32 bg-olive-200/50 rounded-full blur-3xl" />
                <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-earth-200/50 rounded-full blur-2xl" />
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Subtle wave divider */}
        <div className="absolute bottom-0 left-0 right-0 h-24 bg-cream-50" style={{
          clipPath: 'ellipse(70% 100% at 50% 100%)'
        }} />
      </section>

      {/* Benefits Section - Premium Icons */}
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card-premium p-8 text-center group">
              <div className="w-16 h-16 bg-cream-100 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-cream-200 transition-colors">
                <Wheat className="w-8 h-8 text-earth-500" strokeWidth={1.5} />
              </div>
            ...
            {/* Benefit 2 */}
            <div className="card-premium p-8 text-center group">
              <div className="w-16 h-16 bg-earth-50 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-earth-100 transition-colors">
            ...
            {/* Benefit 3 */}
            <div className="card-premium p-8 text-center group">
              <div className="w-16 h-16 bg-olive-50 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-olive-100 transition-colors">
                <TreeDeciduous className="w-8 h-8 text-olive-600" strokeWidth={1.5} />
              </div>
              <h3 className="font-display text-xl font-medium text-stone-800 mb-4">
            ...
            <div className="card-premium p-8 text-center group">
              <div className="w-16 h-16 bg-cream-200 rounded-2xl flex items-center justify-center mb-6 mx-auto group-hover:bg-cream-300 transition-colors">
                <Sparkles className="w-8 h-8 text-stone-600" strokeWidth={1.5} />
              </div>
              <h3 className="font-display text-xl font-medium text-stone-800 mb-4">
                Sin aditivos
              </h3>
      ...
      {/* Pricing/Packs Section - Premium Pricing Table */}
      <section className="section bg-cream-100">
        <div className="container-custom">
            ...
            {packOptions.map((pack, index) => (
              <div
                ...
                className={`relative bg-white rounded-2xl p-7 transition-all duration-400 animate-fade-in-up ${
                  pack.size === 4
                    ? 'ring-2 ring-earth-500 shadow-card-hover scale-[1.02] z-10'
              ...
              >
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  ...
                  <span className="text-stone-400">/ud.</span>
                </div>
                ...
                <ul className="space-y-3 text-sm text-stone-500 mb-6">
                  <li className="flex items-center gap-3">
                    <Check className="w-4 h-4 text-olive-500 flex-shrink-0" strokeWidth={2.5} />
          ...
          {/* Subscription CTA */}
          <div className="mt-16 bg-stone-900 rounded-3xl p-12 md:p-16 text-center overflow-hidden relative">
            {/* Background decoration */}
            <div className="absolute top-0 right-0 w-80 h-80 bg-earth-600/20 rounded-full blur-3xl" />
            <div className="absolute bottom-0 left-0 w-64 h-64 bg-olive-600/20 rounded-full blur-3xl" />
