      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-neutral-200">
            ...
            <h3 className="font-semibold text-neutral-900 mb-2">Entrega en mano</h3>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-neutral-200">
            ...
            <h3 className="font-semibold text-neutral-900 mb-2">Apoya el proyecto</h3>
            <p className="text-neutral-600 text-sm">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-neutral-200">
            ...
            <h3 className="font-semibold text-neutral-900 mb-2">Producto fresco</h3>
            <p className="text-neutral-600 text-sm">
