...
export const metadata: Metadata = {
  title: 'Tienda',
  description:
    'Compra granola artesanal sin gluten, ecológica y premium. Elige entre nuestros sabores y packs. Envío gratis a partir de 4 bolsas.',
};
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
            Granola artesanal elaborada con ingredientes de calidad.
