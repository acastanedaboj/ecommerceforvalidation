              ...
              return (
                ...
                >
                  ...
                  {option.discountPercentage > 0 && (
                    <span className="absolute -top-2 -right-2 px-2 py-0.5 bg-olive-500 text-[#fcf8d5] text-xs font-bold rounded-full">
                      -{Math.round(option.discountPercentage)}%
                    </span>
                  )}
                  {/* Free shipping badge */}
                  {option.freeShipping && (
                    <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 px-2 py-0.5 bg-earth-500 text-[#fcf8d5] text-[10px] font-medium rounded-full whitespace-nowrap">
                      Envío gratis
                    </span>
                  )}
                </button>
