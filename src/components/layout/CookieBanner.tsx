            ...
            <div className="flex items-start gap-3 flex-1">
              ...
              <div>
                ...
                <p className="text-sm text-neutral-600">
                  ...
                  experiencia de navegación y analizar el uso del sitio.{' '}
                  <Link
                    href="/legal/cookies"
              ...
              <div className="border border-neutral-200 rounded-lg p-4">
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-neutral-600">
                      Esenciales para el funcionamiento del sitio web (carrito
                      de compra, inicio de sesión). No se pueden desactivar.
                    </p>
                  </div>
                  <div className="ml-4">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-neutral-600">
                      ...
                      el sitio web (Google Analytics). Datos anonimizados.
                    </p>
                  </div>
                  <div className="ml-4">
                    <button
