      ...
      <div className="container-custom py-16 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            <h3 className="text-[#ffffec] font-bold text-[15px] lowercase mb-5" style={{ fontFamily: 'var(--font-display)', fontWeight: 700 }}>Tienda</h3>
          ...
          {/* Empresa links */}
          <div className="lg:col-span-2">
            <h3 className="text-[#ffffec] font-bold text-[15px] lowercase mb-5" style={{ fontFamily: 'var(--font-display)', fontWeight: 700 }}>Empresa</h3>
            <ul className="space-y-3.5">
          ...
          {/* Recursos links */}
          <div className="lg:col-span-2">
            <h3 className="text-[#ffffec] font-bold text-[15px] lowercase mb-5" style={{ fontFamily: 'var(--font-display)', fontWeight: 700 }}>Recursos</h3>
            <ul className="space-y-3.5">
          ...
          {/* Contacto */}
          <div className="lg:col-span-2">
            <h3 className="text-[#ffffec] font-bold text-[15px] lowercase mb-5" style={{ fontFamily: 'var(--font-display)', fontWeight: 700 }}>Contacto</h3>
