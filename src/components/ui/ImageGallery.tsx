  ...
  return (
    <div className={cn('flex flex-col gap-4', className)}>
      ...
      <div className="relative">
        ...
        {/* Image counter */}
        {hasMultipleImages && (
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 px-3 py-1.5 bg-stone-900/70 backdrop-blur-sm text-[#fcf8d5] text-xs font-medium rounded-full">
        ...
        <div className="flex gap-3 overflow-x-auto scrollbar-hide pb-1">
          {images.map((image, index) => (
            <button
              ...
              className={cn(
                'relative flex-shrink-0 w-20 h-20 overflow-hidden transition-all duration-300',
