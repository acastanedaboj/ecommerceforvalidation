...
export function welcomeEmail(data: WelcomeEmailData): { subject: string; html: string } {
  ...
  const content = `
    ...
    <p>
      Elaboramos cada lote de granola <strong>a mano en Málaga</strong>, con ingredientes naturales
    ...
    <div class="card" style="background-color: #FFFEF8;">
      ...
      <ul style="padding-left: 20px; margin: 0; line-height: 1.8;">
        <li><strong>Original</strong> – La receta original con miel y un toque crujiente perfecto</li>
